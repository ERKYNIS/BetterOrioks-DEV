...
import betterorioks.composeapp.generated.resources.sno
...
import betterorioks.composeapp.generated.resources.social_sno
...
fun TextButtonColumn(
    ...
    Column(
        ...
        HorizontalIconTextButton(
            painterResource(Res.drawable.sno),
            text = stringResource(Res.string.social_sno),
            onClick = { urlHandler.handleUrl(UsefulUrls.SNO_URL) },
            modifier = Modifier.fillMaxWidth()
        )
        HorizontalIconTextButton(
