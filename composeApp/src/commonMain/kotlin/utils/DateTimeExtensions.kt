...
fun now(offsetSeconds: Int = 0): LocalDateTime =
    kotlin.time.Clock.System.now().plus(offsetSeconds, DateTimeUnit.SECOND).toLocalDateTime(TimeZone.currentSystemDefault())
